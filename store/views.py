...
def shop(request):
	...
	return render(request, 'shop.html', {'posti': posti, 'tape': tape, 'amade' : amade})
...
def products_show(request, pk):
	...
	return render(request, 'product_show.html', {'product_show' : product_show, 'posti': posti, 'chap': chap, 'ready': ready})


def product_amade(request):
    return render(request, 'product_amade.html', {})

def product_nemone(request):
    products = ProductChoose.objects.all()
    return render(request, 'product_nemone.html', {'products':products})
...
def bime(request):
    return render(request, 'bime.html', {})



def amozesh(request):
    return render(request, 'amozesh.html', {})



def amozesha(request):
    return render(request, 'amozesha.html', {})


def amozeshb(request):
    return render(request, 'amozeshb.html', {})


def amozeshc(request):
    return render(request, 'amozeshc.html', {})


def amozeshd(request):
    return render(request, 'amozeshd.html', {})
